...
This proposed solution will be (for the time being) a valid solution, if the solution submitter will load all details of his solution on-chain within another **C/2** minutes.
