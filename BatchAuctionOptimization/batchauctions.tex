...
\newcommand*{\token}{\tau}                  % Symbol for a token.
\newcommand*{\tokens}{\mathcal{T}}          % Set of tokens.
\newcommand*{\order}{\omega}                % Symbol for an order.
...
\newcommand*{\uniswaps}{\mathcal{U}}        % Set of Uniswap pools.
\newcommand*{\uniswap}{\nu}                 % Symbol for a Uniswap pool.
...
\newcommand*{\iuniswaps}{\mathcal{I}^u}     % Set of pool indices.
...
\begin{figure}[h!]
  \begin{subfigure}{0.25\textwidth}
    \input{figures/tex/functional_sell_demand_1.tex}
    \caption{$a \cdot \pi + b = 0$}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.25\textwidth}
    \input{figures/tex/functional_sell_demand_2.tex}
    \caption{$a \cdot \pi + b > 0$}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.25\textwidth}
    \input{figures/tex/functional_sell_demand_3.tex}
