...
The results of our computational experiments as in \tabref{tab:results_mip1_bigm} and 
\tabref{tab:results_mip2_dp}
show that runtimes of the MIP formulation sharply increase both with the number of assets and the
number of orders that are being considered.

\todo[inline]{More verbal explanation on results!}
  ...
  \begin{subtable}[h]{\textwidth}
    ...
    \begin{tabular}{C{16mm}R{20mm}R{15mm}R{15mm}R{15mm}R{15mm}}
      ...
      200       & $ \varnothing $ runtime &  0.42 &   1.78 &     2.26 &   6.67 \\
                ...
                & -- $ \varnothing $ gap  &     - &      - &        - &      - \\
      \midrule
      500       & $ \varnothing $ runtime &  3.46 & 158.66 &        . &      . \\
                & \# timeouts             &     0 &      0 &        . &      . \\
                & -- $ \varnothing $ gap  &     - &      - &        . &      . \\
      \bottomrule
    \end{tabular}
  ...
  \begin{subtable}[h]{\textwidth}
    ...
    \begin{tabular}{C{16mm}R{20mm}R{15mm}R{15mm}R{15mm}R{15mm}}
      ...
      200       & $ \varnothing $ runtime &  0.92 &   3.34 &     4.08 &  12.28 \\
                ...
                & -- $ \varnothing $ gap  &     - &      - &        - &      - \\
      \midrule
      500       & $ \varnothing $ runtime &  6.96 & 184.60 &        . &      . \\
                & \# timeouts             &     0 &      1 &        . &      . \\
                & -- $ \varnothing $ gap  &     - & 3.25\% &        . &      . \\
      \bottomrule
    \end{tabular}
  ...
  \begin{subtable}[h]{\textwidth}
    ...
    \begin{tabular}{C{16mm}R{20mm}R{15mm}R{15mm}R{15mm}R{15mm}}
      ...
      200       & $ \varnothing $ runtime &   4.14 &  18.40 &   14.27 &  20.18 \\
                ...
                & -- $ \varnothing $ gap  &      - &      - &       - &      - \\
      \midrule
      500       & $ \varnothing $ runtime & 647.98 & 646.57 &       . &      . \\
                & \# timeouts             &      0 &     19 &       . &      . \\
                & -- $ \varnothing $ gap  &      - & 8.19\% &       . &      . \\
      \bottomrule
    \end{tabular}
  ...
  \begin{subtable}[h]{\textwidth}
    ...
    \begin{tabular}{C{16mm}R{20mm}R{15mm}R{15mm}R{15mm}R{15mm}}
      ...
      200       & $ \varnothing $ runtime &  1.18 &   8.81 &   10.64 &  25.50 \\
                ...
                & -- $ \varnothing $ gap  &     - &      - &       - &      - \\
      \midrule
      500       & $ \varnothing $ runtime & 24.70 & 288.50 &       . &      . \\
                & \# timeouts             &     0 &      3 &       . &      . \\
                & -- $ \varnothing $ gap  &     - & 2.31\% &       . &      . \\
      \bottomrule
    \end{tabular}
